...
class Settings(BaseSettings):
    ...
    # 应用配置
    APP_NAME: str = "MultiKB Knowledge Base"
    ...
    # 数据库配置
    DATABASE_URL: str = "mysql+pymysql://user:password@localhost:3306/multikb_knowledge"
    ...
    MINIO_BUCKET_NAME: str = "multikb-knowledge-base"
